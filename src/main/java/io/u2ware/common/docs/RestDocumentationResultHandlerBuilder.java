...
public class RestDocumentationResultHandlerBuilder {
    ...
    public static RestDocumentationResultHandler build(String identifier, Consumer<RestDocumentationResultHandlerBuilder> function){

        RestDocumentationResultHandlerBuilder builder = new RestDocumentationResultHandlerBuilder(identifier);
...
//        if(builder.requestParameters.size() >  0){snippets.add(RequestDocumentation.requestParameters(builder.requestParameters));}
        if(builder.requestParameters.size() >  0){snippets.add(RequestDocumentation.relaxedFormParameters(builder.requestParameters));}
    ...
    private RestDocumentationResultHandlerBuilder(String identifier) {
